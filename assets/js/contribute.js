    ...
    if (imageWrapper) {
        ...
        const initImageItem = (item, isNew = false) => {
            ...
            if (existingSrc) {
                ...
                item.dataset.isTemp =
                    existingSrc.includes('/images_tmp/') ? 'true' : 'false';
        ...
        const addImage = () => {
            ...
            div.innerHTML =
                proto.dataset.prototype.replace(/__name__/g, index);
    ...
    if (videoWrapper) {
        ...
        const initVideoItem = (item, isNew = false) => {
            ...
            const updatePreview = () => {
                ...
                else if (!value && preview?.getAttribute('src')) {
                    preview.classList.remove('hidden');
                    placeholder?.classList.add('hidden');
                }
                else {
        ...
        const addVideo = () => {
            ...
            div.innerHTML =
                proto.dataset.prototype.replace(/__name__/g, videoIndex);
